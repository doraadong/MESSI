...
def get_multigaussian_pdf(_mean, _cov, _cov_i, num_variable, Y_variable):
    ...
    Args:
        _mean: numpy array, N x num_variable (N: sample size), mean
        _cov: numpy array, num_variable x num_variable, covariance matrix
        _cov_i: numpy array, num_variable x num_variable, inverse of the covariance matrix
        num_variable: integer, number of variables
        Y_variable: numpy array, N x num_variable, realized values of the random variables
